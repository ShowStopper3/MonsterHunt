...
/**
 * It is representation of current room , We have certain co-ordinates against
 * every room in json This class takes two possible constructions: either a
 * string or three integers. Either way, it is parsed into a Coordinate.
 *
 *
 * @author ssachdev
 *
