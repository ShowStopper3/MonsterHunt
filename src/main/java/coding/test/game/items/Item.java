package coding.test.game.items;

import java.util.Collections;
import java.util.Map;
import java.util.TreeMap;

import coding.test.game.characters.EquipmentLocation;
...
public class Item {
	...
	public void display() {
		QueueServices.offer("Name: " + name + "\nDescription: " + description + "\nLevel: " + level);
		for (Map.Entry<String, Integer> entry : properties.entrySet()) {
			QueueServices.offer(entry.getKey() + ": " + entry.getValue());
		}
	}
