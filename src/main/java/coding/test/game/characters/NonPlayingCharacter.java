...
/**
 * This class deals with Non Player Character (NonPlayingCharacter) and all of their properties.
 * Any method that changes a NonPlayingCharacter or a player  interacts with it should
 * be placed within this class. If a method deals with entities in general or
 * with variables not unique to the NonPlayingCharacter, place it in the entity class.
 */
public class NonPlayingCharacter extends BaseCharcter {
    private int xpGain;
    private String id;
    ...
    public NonPlayingCharacter(String entityID) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof NonPlayingCharacter) {
            NonPlayingCharacter npc = (NonPlayingCharacter) obj;
